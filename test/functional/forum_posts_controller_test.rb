...
class ForumPostsControllerTest < ActionController::TestCase
  ...
  test "should create forum_post" do
    assert_difference('ForumPost.count') do
      post :create, forum_post: { body: @forum_post.body, name: @forum_post.name, subject: @forum_post.subject }
    end
  ...
  test "should update forum_post" do
    put :update, id: @forum_post, forum_post: { body: @forum_post.body, name: @forum_post.name, subject: @forum_post.subject }
    assert_redirected_to forum_post_path(assigns(:forum_post))
  end
